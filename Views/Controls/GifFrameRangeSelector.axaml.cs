...
{
    public partial class GifFrameRangeSelector : UserControl
    {
        ...
        public static readonly StyledProperty<int> MinimumProperty =
            AvaloniaProperty.Register<GifFrameRangeSelector, int>(nameof(Minimum), 0);

        public static readonly StyledProperty<int> MaximumProperty =
            AvaloniaProperty.Register<GifFrameRangeSelector, int>(nameof(Maximum), 1);

        public static readonly StyledProperty<int> StartValueProperty =
            AvaloniaProperty.Register<GifFrameRangeSelector, int>(nameof(StartValue), 0);

        public static readonly StyledProperty<int> EndValueProperty =
            AvaloniaProperty.Register<GifFrameRangeSelector, int>(nameof(EndValue), 0);

        public event EventHandler<GifFrameRangeChangedEventArgs>? RangeChanged;

        public GifFrameRangeSelector()
        {
            InitializeComponent();
            ...
            switch (_activeThumb)
            {
                case ActiveThumb.Start:
                    ...
                    if (value != StartValue)
                    {
                        ...
                        RangeChanged?.Invoke(this, new GifFrameRangeChangedEventArgs(StartValue, EndValue));
                    }
                    break;
    ...
    public sealed class GifFrameRangeChangedEventArgs : EventArgs
    {
        public GifFrameRangeChangedEventArgs(int startValue, int endValue)
        {
